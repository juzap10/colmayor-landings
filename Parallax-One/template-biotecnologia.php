         ...
         <div class="mobile-bg-fix-whole-site">
            ...
            <div itemprop="" id="content" class="content-warp" role="main">
              ...
              <section class="brief text-left brief-design-one brief-left" id="informacion-programa" role="region" aria-label="About">
                        ...
                        <div class="row">
                           ...
                           <div class="col-xs-10 col-xs-offset-1  col-md-offset-0  col-md-6 brief-content-one">
                              <div class="brief-image-right">
                                 <img src="//programas.colmayor.edu.co/wp-content/themes/Parallax-One/images/biotecnologia/imagen_circulo.jpg" alt="Informacion Programa" style="width: 350px;height: 350px; border-radius: 95%;padding: 10px; border: 3px solid #0E8080;">
                              </div>
                           </div>
                           <!-- BRIEF HEADING -->
                     ...
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-xs-10 col-xs-offset-1 col-md-5 col-md-offset-1 content-section brief-content-two">
                           		<h2 class="text-center dark-text"><span style="border-bottom: 2px solid #0E8080;padding: 0 20px;">PERFIL DEL GRADUADO</span></h2>
                              <div class="brief-content-text text-justify" >
                              	<p><img src="//programas.colmayor.edu.co/wp-content/themes/Parallax-One/images/biotecnologia/imagen_objeto-de-estudio.jpg" alt="Perfil graduado" ></p>
               ...
               <section class="call-to-action ribbon-wrap" id="five-razones" style="background-image:url(//programas.colmayor.edu.co/wp-content/themes/Parallax-One/images/biotecnologia/imagen_cinco_razones.jpg) !important; " role="region" aria-label="Ribbon">
                  <div class="section-overlay-layer">
               ...
               <section class="services" id="testimonios" role="region" aria-label="Services">
                  <div class="section-overlay-layer">
                     <div class="container">
                        <div class="section-header">
                           <h2 style="color:#0E8080">TESTIMONIOS</h2>
                           <div class="sub-heading"><p>"Con la biotecnologías vos podes poner a volar tu imaginación, porque podes encontrar la respuesta a aquello que pareciera no tener explicación" </p>
                           <p>Alejandro Arango -</p>
                           </div>

                        </div>
                        <div class="col-md-12">
                        	<iframe src="https://www.youtube.com/embed/IWEsVBCp3BA" frameborder="0" allowfullscreen></iframe>
                        </div>
                     </div>
                  </div>
               </section>
               ...
               <!-- .brief-design-one -->
               <section class="team" id="creditos-educativos" role="region" aria-label="Team" style="background-color: #fff;">
                  <div class="section-overlay-layer">
                     <div class="container">
                        <div class="section-header">
                           <h2 style="color:#0E8080">CRÉDITOS EDUCATIVOS Y BECAS</h2>
            ...
            <!-- .content-wrap -->
            <footer itemscope="" itemtype="http://schema.org/WPFooter" id="footer" role="contentinfo" class="footer grey-bg" style="background-color: #272727;">
               <div class="container">
