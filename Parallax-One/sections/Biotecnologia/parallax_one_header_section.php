...
$paralax_one_header_logo = get_theme_mod( 'biotecnologia_paralax_one_header_logo', parallax_get_file( '/images/logo-2.png' ) );
$paralax_one_header_logo = apply_filters( 'parallax_one_translate_single_string', $paralax_one_header_logo, 'Big Title Section' );

$parallax_one_header_title = get_theme_mod( 'biotecnologia_parallax_one_header_title', esc_html__( 'Simple, Reliable and Awesome.', 'parallax-one' ) );
$parallax_one_header_title = apply_filters( 'parallax_one_translate_single_string', $parallax_one_header_title, 'Big Title Section' );

$parallax_one_header_subtitle = get_theme_mod( 'biotecnologia_parallax_one_header_subtitle', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' );
...
$parallax_one_header_button_text = get_theme_mod( 'biotecnologia_parallax_one_header_button_text', esc_html__( 'GET STARTED', 'parallax-one' ) );
...
$parallax_one_header_button_link = get_theme_mod( 'biotecnologia_parallax_one_header_button_link', '#' );
...
$parallax_one_first_layer = get_theme_mod( 'biotecnologia_paralax_one_first_layer', parallax_get_file( '/images/background1.png' ) );
$parallax_one_first_layer = apply_filters( 'parallax_one_translate_single_string', $parallax_one_first_layer, 'Big Title Section' );

$parallax_one_second_layer = get_theme_mod( 'biotecnologia_paralax_one_second_layer', parallax_get_file( '/images/background2.png' ) );
